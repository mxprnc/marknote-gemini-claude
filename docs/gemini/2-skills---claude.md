...
### CLAUDE.md vs Skills
![alt text](<./img/2-skills---gemini/CleanShot 2026-03-23 at 16.26.36@2x.png>)
...
### skills.md 의 구조
![alt text](<./img/2-skills---gemini/CleanShot 2026-03-23 at 16.51.39@2x.png>)
...
![alt text](<./img/2-skills---gemini/CleanShot 2026-03-23 at 16.57.31@2x.png>)
...
## e.g. ppt 스킬 직접 만들기
![alt text](<./img/2-skills---gemini/CleanShot 2026-03-23 at 16.59.48@2x.png>)
...
claude 실행
![alt text](<./img/2-skills---gemini/CleanShot 2026-03-23 at 17.02.18@2x.png>)
<br/>

`/plugin` -> `Marketplaces` 탭 선택
![alt text](<./img/2-skills---gemini/CleanShot 2026-03-23 at 17.03.42@2x.png>)
<br/>

`skill-creator` 검색
![alt text](<./img/2-skills---gemini/CleanShot 2026-03-23 at 17.05.07@2x.png>)
<br/>

skil-creator 실행
![alt text](<./img/2-skills---gemini/CleanShot 2026-03-23 at 17.07.14@2x.png>)
...
![alt text](<./img/2-skills---gemini/CleanShot 2026-03-23 at 17.09.21@2x.png>)

<br/>

설명은 파일을 열어보면 되기에 일단은 /clear 로 화면을 깨끗하게 치운다.
![alt text](<./img/2-skills---gemini/CleanShot 2026-03-23 at 17.13.31@2x.png>)
...
skill 실행
만든 skill 을 실행해본다.
![alt text](<./img/2-skills---gemini/CleanShot 2026-03-23 at 17.14.20@2x.png>)
<br/>
...
## skill 저장 위치, 번들 스킬
![alt text](<./img/2-skills---gemini/CleanShot 2026-03-23 at 17.18.18@2x.png>)
